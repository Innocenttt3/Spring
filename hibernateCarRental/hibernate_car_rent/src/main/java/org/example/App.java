...
public class App {
    ...
    private final IVehicleRepository iv = VehicleDAO.getInstance(HibernateUtil.getSessionFactory());
        ...
        while(running) {
            ...
            switch (response) {
                ...
                case "7":
                    ...
                    break;
                case "8":
                    System.out.println("to add user, pass his login");
                    String login = scanner.nextLine();
                    System.out.println("pass his password");
                    String password = scanner.nextLine();
                    String hashedPassword = Authenticator.hashPassword(password);
                    iur.addUser(new User(login,hashedPassword));
                    break;
                case "9":
